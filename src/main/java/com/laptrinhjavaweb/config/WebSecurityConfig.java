...
//                        .antMatchers("/admin/**").hasRole("MANAGER")
                        ...
                        .antMatchers("/admin/building-update-**").hasAnyRole("MANAGER", "STAFF")
                        .antMatchers("/admin/building-update").hasRole("MANAGER")
                        .antMatchers("/admin/customer-update-**").hasAnyRole("MANAGER", "STAFF")
                        .antMatchers("/admin/customer-update").hasRole("MANAGER")
                        .antMatchers("/login", "/resource/**", "/api/**").permitAll()
                .and()
